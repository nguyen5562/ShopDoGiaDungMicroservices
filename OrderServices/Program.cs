...
using OrderServices.Authorization;
using OrderServices.Data;
using OrderServices.Services.Implementations;
...
builder.WebHost.ConfigureKestrel(options =>
{
    ...
    options.Listen(IPAddress.Loopback, 5195);

    // Lắng nghe trên cổng 7248 cho HTTPS
    options.Listen(IPAddress.Loopback, 7079, listenOptions =>
    {

...
namespace OtherServices.Services.Implementations
{
    public class OrderService : IOrderService
    {
        ...
        public OrderService(OtherDbContext context, IMinioService minioService, IOrderNotificationService orderNotificationService, IHttpContextAccessor httpContextAccessor)
        {
            _context = context;

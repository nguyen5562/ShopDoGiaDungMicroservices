...
using OtherServices.Authorization;
using OtherServices.Data;
using OtherServices.Services.Implementations;
...
builder.Services.AddCors(options =>
{
    ...
    {
        policy.AllowAnyOrigin() // Chỉ định các origin bạn cho phép
              .AllowAnyHeader()
              .AllowAnyMethod()
...
builder.WebHost.ConfigureKestrel(options =>
{
    ...
    options.Listen(IPAddress.Loopback, 5237);

    // Lắng nghe trên cổng 7248 cho HTTPS
    options.Listen(IPAddress.Loopback, 7108, listenOptions =>
    {
